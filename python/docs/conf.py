...
# -*- coding: utf-8 -*-
#
# ts-flint documentation build configuration file, created by
...
import ts.flint
version = '.'.join(ts.flint.__version__.split('.')[:2])
# The full version, including alpha/beta/rc tags.
release = ts.flint.__version__
...
latex_documents = [
    (master_doc, 'ts-flint.tex', 'ts-flint Documentation',
     'Two Sigma Open Source, LLC.', 'manual'),
]
...
man_pages = [
    (master_doc, 'ts-flint', 'ts-flint Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ts-flint', 'ts-flint Documentation',
     author, 'ts-flint', 'One line description of project.',
     'Miscellaneous'),
]
