...
def get_codebase_params():
    ...
    if os.getenv(flintjar_env):
        codebase_params = {'spark_version': default_spark_version,
                           'additional_jars': [os.getenv(flintjar_env)]}
    else:
        codebase_params = {'codebase': os.getenv(codebase_env, default_codebase)}
